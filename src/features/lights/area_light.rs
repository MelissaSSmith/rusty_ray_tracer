...
impl AreaLight {
    pub fn create(corner: Point, v1: Vector, u_steps: usize, v2: Vector, v_steps: usize, intensity: Color, jitter: bool) -> Self {
    ...
    pub fn with_jitter(self, jitter: Sequence) -> Self {
        Self {
            jitter,
            ..self
        }
