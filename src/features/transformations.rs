...
mod tests {
    ...
    use crate::features::transformations::{rotation_x, rotation_y, rotation_z, scaling, shearing, translation};
    ...
    fn test_rotate_point_around_x_axis() {
        ...
        let half_quarter = rotation_x(&half_quarter_radians);
        ...
        let full_quarter = rotation_x(&full_quarter_radians);
    ...
    fn test_rotate_point_around_y_axis() {
        ...
        let half_quarter_radians = PI / 4.0;
        let half_quarter = rotation_y(&half_quarter_radians);
        ...
        let point = Point::create(0.0, 0.0, 1.0);
        let full_quarter_radians = PI / 2.0;
        let full_quarter = rotation_y(&full_quarter_radians);
    ...
    fn test_rotate_point_around_z_axis() {
        let point = Point::create(0.0, 1.0, 0.0);
        let half_quarter_radians = PI / 4.0;
        let half_quarter = rotation_z(&half_quarter_radians);
        ...
        let point = Point::create(0.0, 1.0, 0.0);
        let full_quarter_radians = PI / 2.0;
        let full_quarter = rotation_z(&full_quarter_radians);
