...
fn sphere_scene_test() {
    ...
    let mid_material = Material::create_with_attributes(0.1, 0.7, 0.3, None, Some(0.75), None, Some(Box::new(mid_perturb_pattern))); //todo: change
    ...
    let r_material = Material::create_with_attributes(0.1, 0.7, 0.3, None, None, None, Some(Box::new(r_perturb_pattern))); //todo: change
